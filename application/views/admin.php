...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?=base_url()?>index.php/admin_controller/index" class="logo">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?=base_url()?>assets/admin/dist/img/fatih.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li>
        <a href="<?php echo base_url(); ?>ark_admin/admin/users">
        <i></i> <span>Üyeler</span>
        </a>
        </li>
        <li>
        <a href="<?php echo base_url(); ?>ark_admin/admin/users">
